    ...
    <div class="container px-4 py-2">
     <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
      <div class="feature col div-choice">
        ...
        <ul>
              <li><span class="scenario-objective">Schema design for a messaging data use case</span></li>
              <li><span class="scenario-objective">Sample messaging data</span></li>
              <li><span class="scenario-objective">CQL queries over messaging data</span></li>
        </ul>
